...
namespace MissingNopedia
{
	public static class HackedUri
	{
		...
		[Obsolete("Not supposed to be used anymore.")]
		public static Uri Create(string url)
		{
			//typeof(Uri).GetField("s_IriParsing", BindingFlags.NonPublic | BindingFlags.Static).SetValue(null, false); // Desactivate IriParsing to parse quotes "'".
